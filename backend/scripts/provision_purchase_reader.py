...
TABLES = {
    ...
    'T_PUR_RECEIVE': 'FID FBILLNO FDATE FDOCUMENTSTATUS FCANCELSTATUS FSUPPLIERID FSTOCKORGID',
    ...
    'T_PUR_MRB': 'FID FBILLNO FDATE FDOCUMENTSTATUS FCANCELSTATUS FSUPPLIERID FSTOCKORGID',
