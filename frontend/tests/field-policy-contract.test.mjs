...
assert.match(view, /PmsSegmentedControl/)
assert.match(view, /PmsTextControl/)
assert.match(view, /PmsSelectControl/)
assert.match(view, /PmsSwitchControl/)
assert.doesNotMatch(view, /<el-(segmented|input|select|switch)\b/)
