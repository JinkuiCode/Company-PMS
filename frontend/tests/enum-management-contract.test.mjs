...
assert.match(projectArchive, /enumLabel\('product_category'/)
assert.match(projectArchive, /enumLabel\('equipment_series'/)
assert.match(projectList, /productCategoryLabelMap/)
